...
The datasets used in the paper can be downloaded <a href="https://raw.githubusercontent.com/caterinaLacerra/alasca/master/docs/assets/alasca_dataset.zip" download target="_blank">here</a>. The .zip folder contains the following files:
